...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-zinc-800 border border-transparent hover:border-slate-200 dark:hover:border-zinc-700 text-xs font-medium transition-all duration-150"
    >
